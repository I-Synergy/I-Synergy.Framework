...
namespace Mollie.Sample.Services.Customer
{
    ...
    /// Implements the <see cref="Mollie.Sample.Services.OverviewClientBase{ISynergy.Framework.Payment.Mollie.Models.Customer.CustomerResponse}" />
    /// Implements the <see cref="Mollie.Sample.Services.Customer.ICustomerOverviewClient" />
    /// </summary>
    /// <seealso cref="Mollie.Sample.Services.OverviewClientBase{ISynergy.Framework.Payment.Mollie.Models.Customer.CustomerResponse}" />
    /// <seealso cref="Mollie.Sample.Services.Customer.ICustomerOverviewClient" />
    /// <autogeneratedoc />
