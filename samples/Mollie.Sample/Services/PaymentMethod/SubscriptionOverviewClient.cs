...
namespace Mollie.Sample.Services.PaymentMethod
{
    ...
    /// Implements the <see cref="Mollie.Sample.Services.OverviewClientBase{ISynergy.Framework.Payment.Mollie.Models.PaymentMethod.PaymentMethodResponse}" />
    /// Implements the <see cref="Mollie.Sample.Services.PaymentMethod.IPaymentMethodOverviewClient" />
    /// </summary>
    /// <seealso cref="Mollie.Sample.Services.OverviewClientBase{ISynergy.Framework.Payment.Mollie.Models.PaymentMethod.PaymentMethodResponse}" />
    /// <seealso cref="Mollie.Sample.Services.PaymentMethod.IPaymentMethodOverviewClient" />
    /// <autogeneratedoc />
