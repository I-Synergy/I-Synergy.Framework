...
public static class FluentUI
{
    ...
    public const string password_16_regular = "\ue8c8"; // NOSONAR - icon glyph constant, not a credential
    public const string password_20_regular = "\ue8c9"; // NOSONAR - icon glyph constant, not a credential
    public const string password_24_regular = "\uf59e"; // NOSONAR - icon glyph constant, not a credential
    public const string password_32_regular = "\U000f05ae"; // NOSONAR - icon glyph constant, not a credential
    public const string password_48_regular = "\U000f05af"; // NOSONAR - icon glyph constant, not a credential
    public const string password_clock_48_regular = "\U000f05b0"; // NOSONAR - icon glyph constant, not a credential
    public const string password_reset_48_regular = "\U000f05b1"; // NOSONAR - icon glyph constant, not a credential
