...
public static class LoggingBuilderExtensions
{
    ...
    /// </summary>
    public static ILoggingBuilder AddApplicationInsightsTelemetry(
    ...
    {
        builder.Services.AddApplicationInsightsTelemetry(configuration, environment, infoService, defaultTelemetrySection, tracingAction, metricsAction, loggerAction);
        return builder;
    }
}
