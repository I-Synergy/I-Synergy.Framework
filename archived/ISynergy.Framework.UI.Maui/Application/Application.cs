...
public abstract class Application : Microsoft.Maui.Controls.Application, IDisposable
{
    ...
    /// </summary>
    public static Microsoft.Maui.Controls.Window? MainWindow
    {
        get
        {
    ...
    protected override void OnStart()
    {
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                var errorWindow = new Microsoft.Maui.Controls.Window();
                var textBlock = new Microsoft.Maui.Controls.Label
                {
