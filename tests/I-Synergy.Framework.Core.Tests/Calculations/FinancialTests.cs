...
namespace ISynergy.Calculations.Tests
{
    public class FinancialTests : UnitTest
    {
        ...
        {
            var assert = Math.Round(Financial.CalcPercAmountOfAmount(amount, mainamount), 4);
        ...
        {
            var result = Financial.CalcPercAmountOfAmount(0m, 0m);
        ...
        {
            var result = Financial.CalcAmountOfPercentage(121, 21);
        ...
        {
            var assert = Financial.CalcMarginPercentage(salesPrice, purchasePrice);
            Assert.Equal(result, assert);
        }
        ...
        {
            var result = Financial.CalcMarginPercentage(100, 0);
