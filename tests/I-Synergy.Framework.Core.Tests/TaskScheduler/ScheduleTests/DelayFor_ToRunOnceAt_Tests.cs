...
{
    using ISynergy.Background.Tasks.Tests.Utilities;
    using Xunit;
    using System;
    using ISynergy.Extensions;
    using ISynergy.Framework.Tests.Base;

    public class DelayFor_ToRunNow_Tests : UnitTest
    {
        [Fact]
        public void Should_Delay_ToRunNow_For_500_Milliseconds()
        {
            ...
            Assert.Equal((expected.Ticks / precisionTicks * precisionTicks), (actual.Ticks / precisionTicks * precisionTicks));
        }
