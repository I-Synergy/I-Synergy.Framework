...
{
    private static readonly double[] EVEN_DATA = [8.2, 6.2, 10.2, 20.2, 16.2, 15.2, 13.2, 3.2, 7.2, 8.2];
    private static readonly double[] ODD_DATA = [8.2, 6.2, 10.2, 9.2, 20.2, 16.2, 15.2, 13.2, 3.2, 7.2, 8.2];
    private static readonly double[] TEST_PROBABILITIES = [0.0, 0.25, 0.5, 0.75, 1.0];
    ...
    {
        double[] expected = [3.2, 7.2, 8.2, 15.2, 20.2];
    ...
    {
        double[] expected = [3.2, 7.2, 9.2, 15.2, 20.2];
    ...
    {
        double[] expected = [3.2, 7.7, 9.2, 15.7, 20.2];
    ...
    {
        double[] expected = [3.2, 7.7, 9.7, 15.7, 20.2];
    ...
    {
        double[] expected = [3.2, 6.2, 8.2, 15.2, 20.2];
    ...
    {
        double[] expected = [3.2, 7.2, 9.2, 13.2, 20.2];
    ...
    {
        double[] expected = [3.2, 6.7, 8.2, 14.2, 20.2];
    ...
    {
        double[] expected = [3.2, 6.95, 8.7, 13.7, 20.2];
    ...
    {
        double[] expected = [3.2, 7.45, 9.20, 14.7, 20.2];
    ...
    {
        double[] expected = [3.2, 6.95, 9.2, 15.45, 20.2];
    ...
    {
        double[] expected = [3.2, 7.45, 9.2, 14.7, 20.2];
    ...
    {
        double[] expected = [3.2, 7.7, 9.2, 14.2, 20.2];
    ...
    {
        double[] expected = [3.2, 7.11666667, 9.2, 15.28333333, 20.2];
    ...
    {
        double[] expected = [3.2, 7.36666667, 9.2, 14.86666667, 20.2];
    ...
    {
        double[] expected = [3.2, 7.1375, 9.2, 15.2625, 20.2];
    ...
    {
        double[] expected = [3.2, 7.3875, 9.2, 14.8250, 20.2];
