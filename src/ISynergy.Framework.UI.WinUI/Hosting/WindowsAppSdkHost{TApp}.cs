...
namespace ISynergy.Framework.UI.Hosting
{
        ...
        where TApp : Application, new()
    {
                    ...
                    IOptions<HostOptions> options)
        {
            ...
            Argument.IsNotNull(applicationLifetime);
            Argument.IsNotNull(logger);
            Argument.IsNotNull(hostLifetime);
        ...
        public async Task StartAsync(CancellationToken cancellationToken = default)
        {
            ...
            async void OnAppOnUnhandledException(object sender, Microsoft.UI.Xaml.UnhandledExceptionEventArgs args)
            {
