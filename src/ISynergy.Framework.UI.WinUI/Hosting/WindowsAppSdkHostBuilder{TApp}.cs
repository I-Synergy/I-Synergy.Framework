...
namespace ISynergy.Framework.UI.Hosting
{
        ...
        where TApp : Application, new()
    {
        ...
        {
            if (_hostBuilt)
                throw new InvalidOperationException(_appServices.GetRequiredService<ILanguageService>().GetString("WarningBuildCalled"));
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            {
                throw new InvalidOperationException(_appServices.GetRequiredService<ILanguageService>().GetString("WarningNullIServiceProvider"));
            }
