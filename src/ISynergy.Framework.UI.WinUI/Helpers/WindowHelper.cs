...
public class WindowHelper
{
    ...
    static public Microsoft.UI.Xaml.Window CreateWindow(Themes theme, string color)
    {
        ...
        SetStyle(newWindow, theme, color);
        return newWindow;
    }
    ...
    /// Sets the theme.
    /// </summary>
    static private void SetStyle(Microsoft.UI.Xaml.Window window, Themes theme, string color)
    {
    ...
    /// Setups the titlebar.
    /// </summary>
    static private void SetTitlebar(Microsoft.UI.Xaml.Window window, Themes theme)
    {
#if WINDOWS
