...
namespace ISynergy.Framework.UI.Controls.Abstractions
{
    ...
    public interface IFilePicker
    {
        ...
        /// during file picking.
        /// </summary>
        /// <param name="allowedTypes">Specifies one or multiple allowed types. When null, all file types
        ...
        /// corresponds how the Windows file open dialog specifies file types.</param>
        /// <returns>File data object, or null when user cancelled picking file</returns>
        Task<FileResult> PickFileAsync(string[] allowedTypes = null);

        /// <summary>
        /// Saves the file that was picked to external storage.
        /// </summary>
        /// <param name="fileToSave">File data from a call to PickFile() that should be saved.</param>
        /// <param name="file">The file.</param>
        /// <returns>FileResult.</returns>
        Task<FileResult> SaveFileAsync(string fileToSave, byte[] file);
