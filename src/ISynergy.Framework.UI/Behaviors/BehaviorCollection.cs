...
namespace ISynergy.Framework.UI.Behaviors
{
    ...
    public sealed class BehaviorCollection : DependencyObjectCollection
    {
        ...
        /// <exception cref="InvalidOperationException">The <see cref="BehaviorCollection"/> is already attached to a different <see cref="DependencyObject"/>.</exception>
        public void Attach(DependencyObject associatedObject)
        {
            ...
            {
                throw new InvalidOperationException(ServiceLocator.Default.GetInstance<ILanguageService>().GetString("CannotAttachBehaviorMultipleTimesExceptionMessage"));
            }
        ...
        private IBehavior VerifiedAttach(DependencyObject item)
        {
            ...
            if (behavior == null)
            {
                throw new InvalidOperationException(ServiceLocator.Default.GetInstance<ILanguageService>().GetString("NonBehaviorAddedToBehaviorCollectionExceptionMessage"));
            }

            if (this._oldCollection.Contains(behavior))
            {
                throw new InvalidOperationException(ServiceLocator.Default.GetInstance<ILanguageService>().GetString("DuplicateBehaviorInCollectionExceptionMessage"));
            }
