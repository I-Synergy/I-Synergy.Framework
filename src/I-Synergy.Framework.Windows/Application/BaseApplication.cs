...
namespace ISynergy
{
    public abstract class BaseApplication : Application
    {
        ...
        {
            await ApplicationHandlers.HandleException(e.Exception);
        }
        ...
        {
            await ApplicationHandlers.HandleException(e.ExceptionObject as Exception);
        }
        ...
        private void OnBackRequested(object sender, BackRequestedEventArgs e)
        {
            ...
            if (ApplicationHandlers.GetDescendantFromName(Window.Current.Content, "ContentRootFrame") is Frame _frame)
            {
                rootFrame = _frame;
            }
        ...
        protected void RegisterAssemblies(List<Assembly> assemblies)
        {
            ...
            ApplicationHandlers.Register(assemblies.ToArray());
            ApplicationHandlers.SetContext(
                _context,
                _logger,
                _preview);
        }
