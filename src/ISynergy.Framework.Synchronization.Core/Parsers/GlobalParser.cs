...
namespace ISynergy.Framework.Synchronization.Core.Parsers
{
    public static class GlobalParser
    {
        ...
        private static ConcurrentDictionary<string, Lazy<ParserString>> parsers = new ConcurrentDictionary<string, Lazy<ParserString>>();
        ...
        private static ParserString InternalParse(string key)
        {
            ...
            else throw new Exception("Lengh of Parser key splitted with ^ is invalid");
