...
namespace ISynergy.Framework.Synchronization.Core.Builders
{
    ...
    public class ParserName
    {
        ...
        //    if (addDatabase && !string.IsNullOrEmpty(DatabaseName))
        //    {
        //        sb.Append(addQuote ? parsedName.QuotedDatabaseName : DatabaseName);
        //        sb.Append(isNormalized ? "_" : ".");
        //    }
        //    if (addSchema && !string.IsNullOrEmpty(SchemaName))
        //    {
        //        sb.Append(addQuote ? parsedName.QuotedSchemaName : SchemaName);
        //        sb.Append(isNormalized ? "_" : ".");
        //    }

        //    var name = addQuote ? parsedName.QuotedObjectName : ObjectName;
