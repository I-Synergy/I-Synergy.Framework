...
namespace ISynergy.Framework.Synchronization.Core.Progress
{
    /// <summary>
    ...
    public class SynchronousProgress<T> : IProgress<T>
    {
        ...
        public SynchronousProgress()
        {
            ...
            Contract.Assert(_synchronizationContext is not null);
        ...
        protected virtual void OnReport(T value)
        {
            ...
            if (handler is not null || changedEvent is not null)
            {
                ...
                _synchronizationContext.Send(_invokeHandlers, value);
            }
        }
