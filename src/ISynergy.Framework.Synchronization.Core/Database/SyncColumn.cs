...
namespace ISynergy.Framework.Synchronization.Core.Database
{
    ...
    public class SyncColumn : SyncNamedItem<SyncColumn>
    {
        ...
        public SyncColumn Clone()
        {
            ...
            clone.DbType = DbType;
            clone.IsAutoIncrement = IsAutoIncrement;
            ...
            clone.ExtraProperty1 = ExtraProperty1;
            return clone;
        }
        ...
        /// </summary>
        public DbType GetDbType() => (DbType)DbType;
        ...
        /// </summary>
        /// <returns></returns>
        public Type GetDataType() => GetTypeFromAssemblyQualifiedName(DataType);
        ...
        {
            var seed = AutoIncrementSeed;
            var step = AutoIncrementStep <= 0 ? 1 : AutoIncrementStep;
        ...
        public override string ToString() => string.Format($"{ColumnName} - {GetDataType().Name}");
        ...
        public override bool EqualsByProperties(SyncColumn column)
        {
            ...
            return
               string.Equals(DataType, column.DataType, sc) &&
               ...
               IsCompute == column.IsCompute &&
               MaxLength == column.MaxLength &&
               Ordinal == column.Ordinal &&
               PrecisionSpecified == column.PrecisionSpecified &&
               Precision == column.Precision &&
               ScaleSpecified == column.ScaleSpecified &&
               Scale == column.Scale &&
               string.Equals(OriginalDbType, column.OriginalDbType, sc) &&
               string.Equals(OriginalTypeName, column.OriginalTypeName, sc) &&
               DbType == column.DbType &&
               string.Equals(DefaultValue, column.DefaultValue, sc) &&
               string.Equals(ExtraProperty1, column.ExtraProperty1, sc);
