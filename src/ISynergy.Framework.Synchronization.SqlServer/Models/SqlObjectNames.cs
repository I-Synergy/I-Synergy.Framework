...
namespace ISynergy.Framework.Synchronization.SqlServer.Models
{
    public class SqlObjectNames
    {
        ...
        private readonly ParserName _tableName;
        private readonly ParserName _trackingName;
        ...
        private string CreateUpdateMetadataCommand()
        {
            ...
            stringBuilder.AppendLine($"LEFT JOIN  {_trackingName.Schema().Quoted().ToString()} [side] ON {pkeysLeftJoinForInsert.ToString()} ");
