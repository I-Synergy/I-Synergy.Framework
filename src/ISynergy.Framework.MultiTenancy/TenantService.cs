...
namespace ISynergy.Services
{
    ...
    public class TenantService : ITenantService
    {
        ...
        public void SetTenant(Guid tenantId)
        {
            ...
            claimIdentity.AddClaim(new Claim(ISynergy.Framework.Core.Constants.ClaimTypes.AccountIdType, tenantId.ToString()));
        ...
        public void SetTenant(Guid tenantId, string username)
        {
            ...
            claimIdentity.AddClaim(new Claim(ISynergy.Framework.Core.Constants.ClaimTypes.AccountIdType, tenantId.ToString()));
            claimIdentity.AddClaim(new Claim(ISynergy.Framework.Core.Constants.ClaimTypes.UserNameType, username));
        ...
        private Guid RetrieveTenantId()
        {
            ...
            Guid.TryParse(principal?.FindFirst(ISynergy.Framework.Core.Constants.ClaimTypes.AccountIdType)?.Value, out var parsedtenant);
            return parsedtenant;
        }
        /// <summary>
        ...
        {
            var principal = _httpContextAccessor.HttpContext.User;
            return principal?.FindFirst(ISynergy.Framework.Core.Constants.ClaimTypes.UserNameType)?.Value;
        }
    }
}
