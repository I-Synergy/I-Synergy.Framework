        ...
        try
        {
            ...
            switch (buttons)
            {
                case MessageBoxButtons.OKCancel:
                    ...
                    try
                    {
                        dialog.PrimaryButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                        dialog.CloseButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                    }
                    catch (Exception ex)
                    {
                ...
                case MessageBoxButtons.YesNoCancel:
                    ...
                    {
                        dialog.PrimaryButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                        dialog.SecondaryButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                        dialog.CloseButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                    }
                    catch (Exception ex)
                    {
    ...
    public async Task CreateDialogAsync<TEntity>(IWindow dialog, IViewModelDialog<TEntity> viewmodel)
    {
        ...
        if (dialog is Window window)
        {
            try
            {
                ...
                try
                {
                    window.PrimaryButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                    window.SecondaryButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                    window.CloseButtonStyle = (Windows.UI.Xaml.Style)Windows.UI.Xaml.Application.Current.Resources["DefaultDialogButtonStyle"];
                }
                catch (Exception ex)
                {
                    _logger.LogWarning(ex, "Failed to set button styles");
