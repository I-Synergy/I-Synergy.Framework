...
public partial class BladeView : UserControl, IDisposable
{
    ...
    public static readonly DependencyProperty DisabledBackgroundProperty = DependencyProperty.Register(nameof(DisabledBackground), typeof(Brush), typeof(BladeView), new PropertyMetadata(Windows.UI.Xaml.Application.Current.Resources.ThemeDictionaries["ApplicationPageBackgroundThemeBrush"] as Brush));
    ...
    private void InitializeDefaultValues()
    {
        ...
        this.DisabledBackground = (Brush)Windows.UI.Xaml.Application.Current.Resources.ThemeDictionaries["ApplicationPageBackgroundThemeBrush"];
