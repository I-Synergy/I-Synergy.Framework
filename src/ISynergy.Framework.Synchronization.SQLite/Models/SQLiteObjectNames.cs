...
namespace ISynergy.Framework.Synchronization.Sqlite.Models
{
    public class SqliteObjectNames
    {
        ...
        private void SetDefaultNames()
        {
            ...
            AddTriggerName(DbTriggerType.Insert, string.Format(insertTriggerName, $"{tpref}{_tableName.Unquoted().Normalized().ToString()}{tsuf}"));
            AddTriggerName(DbTriggerType.Update, string.Format(updateTriggerName, $"{tpref}{_tableName.Unquoted().Normalized().ToString()}{tsuf}"));
            AddTriggerName(DbTriggerType.Delete, string.Format(deleteTriggerName, $"{tpref}{_tableName.Unquoted().Normalized().ToString()}{tsuf}"));
        ...
        private void CreateResetCommandText()
        {
            ...
            stringBuilder.AppendLine($"DELETE FROM {_tableName.Quoted().ToString()};");
            stringBuilder.AppendLine($"DELETE FROM {_trackingName.Quoted().ToString()};");
        ...
        private void CreateUpdateMetadataCommandText()
        {
            ...
            stringBuilder.AppendLine($"INSERT OR REPLACE INTO {_trackingName.Schema().Quoted().ToString()} (");
            ...
            stringBuilder.AppendLine($"          ,@sync_scope_id as sync_scope_id, @sync_row_is_tombstone as sync_row_is_tombstone, {TimestampValue} as sync_timestamp, datetime('now') as UtcDate) as i;");
        ...
        private void CreateInitializeCommandText()
        {
            ...
            stringBuilder.AppendLine($"INSERT OR IGNORE INTO {_tableName.Quoted().ToString()}");
            stringBuilder.AppendLine($"({stringBuilderArguments.ToString()})");
            stringBuilder.Append($"VALUES ({stringBuilderParametersValues2.ToString()}) ");
            stringBuilder.AppendLine($";");

            stringBuilder.AppendLine($"UPDATE OR IGNORE {_trackingName.Quoted().ToString()} SET ");
        ...
        private void CreateUpdateCommandText()
        {
            ...
            stringBuilder.AppendLine($"LEFT JOIN {_trackingName.Quoted().ToString()} AS [side] ON {str1}");
            stringBuilder.AppendLine($"LEFT JOIN {_tableName.Quoted().ToString()} AS [base] ON {str2}");
            ...
            stringBuilder.AppendLine($"INSERT INTO {_tableName.Quoted().ToString()}");
            stringBuilder.AppendLine($"({stringBuilderArguments.ToString()})");
        ...
        private void CreateDeleteMetadataCommandText()
        {
            ...
            var stringBuilder = new StringBuilder();
            stringBuilder.AppendLine($"DELETE FROM {_trackingName.Quoted().ToString()} WHERE [timestamp] < @sync_row_timestamp;");
        ...
        private void CreateDeleteCommandText()
        {
            ...
            stringBuilder.AppendLine($") AS [p]");
            stringBuilder.Append($"\tLEFT JOIN {_trackingName.Quoted().ToString()} [side] ON ");
            stringBuilder.AppendLine($"\t{str7}");
            stringBuilder.AppendLine($"\t)");
        ...
        private void CreateSelectRowCommandText()
        {
            ...
            stringBuilder.AppendLine($"FROM {_trackingName.Quoted().ToString()} [side] ");
            stringBuilder.AppendLine($"LEFT JOIN {_tableName.Quoted().ToString()} [base] ON ");
        ...
        private void CreateSelectChangesCommandText()
        {
            ...
            stringBuilder.AppendLine($"\t[side].[update_scope_id] as [sync_update_scope_id] ");
            stringBuilder.AppendLine($"FROM {_trackingName.Quoted().ToString()} [side]");
            stringBuilder.AppendLine($"LEFT JOIN {_tableName.Quoted().ToString()} [base]");
        ...
        private void CreateUpdateUntrackedRowsCommandText()
        {
            ...
            stringBuilder.AppendLine($", NULL, 0, {TimestampValue}, datetime('now')");
            stringBuilder.AppendLine($"FROM {_tableName.Schema().Quoted().ToString()} as [base] WHERE NOT EXISTS");
            stringBuilder.Append($"(SELECT ");
            stringBuilder.Append(str3.ToString());
            stringBuilder.AppendLine($" FROM {_trackingName.Schema().Quoted().ToString()} as [side] ");
