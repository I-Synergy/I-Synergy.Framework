...
public class UserContextEnrichingLogProcessor : BaseProcessor<LogRecord>
{
    public override void OnEnd(LogRecord data)
    {
        ...
        if (context is not null && context.Profile is not null)
        {
            ...
            attributes.Add(new KeyValuePair<string, object?>("AccountDescription", context.Profile.AccountDescription));
            ...
            attributes.Add(new KeyValuePair<string, object?>("LicenseUsers", context.Profile.LicenseUsers));
            attributes.Add(new KeyValuePair<string, object?>("LicenseExpration", context.Profile.LicenseExpration));
