...
public static class ClaimsPrincipalExtensions
{
    ...
    public static string GetUserId(this ClaimsPrincipal? principal) => principal.GetSingleClaim(Claims.UserId);
    ...
    /// </summary>
    /// <returns>Guid.</returns>
    public static Guid GetTenantId(this ClaimsPrincipal? principal) => principal.GetSingleClaimAsGuid(Claims.TenantId);
