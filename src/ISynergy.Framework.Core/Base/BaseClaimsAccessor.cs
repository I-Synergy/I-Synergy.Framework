...
{
    /// <summary>
    /// Base claims accessor.
    /// </summary>
    public abstract class BaseClaimsAccessor
    {
        /// <summary>
        ...
        /// <exception cref="ClaimNotFoundException"></exception>
        protected abstract List<string> GetClaims(string claimType);
        ...
        protected abstract bool HasClaim(string claimType);
    }
}
