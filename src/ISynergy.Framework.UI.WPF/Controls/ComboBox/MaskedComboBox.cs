...
/// <summary>
/// Custom combobox with Mask
/// </summary>
public sealed class MaskedComboBox : ComboBox
{
    /// <summary>
    /// Represents a mask/format for the textBox that the user must follow
    /// </summary>
    public static readonly DependencyProperty MaskProperty = DependencyProperty.RegisterAttached("Mask", typeof(string), typeof(MaskedComboBox), new PropertyMetadata(string.Empty));
    ...
    /// </summary>
    public static readonly DependencyProperty IsMaskEnabledProperty = DependencyProperty.RegisterAttached("IsMaskEnabled", typeof(bool), typeof(MaskedComboBox), new PropertyMetadata(false));
