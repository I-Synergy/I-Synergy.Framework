...
/// <summary>
/// Reflection-based extension helpers for scanning assemblies and registering Blazor UI types.
/// </summary>
/// <remarks>
...
/// Use the source-generator-emitted <c>AddBlazorRegistrations()</c> extension method instead.
/// </remarks>
public static class ReflectionExtensions
{
    ...
    [RequiresUnreferencedCode("Runtime type registration via reflection is not AOT-compatible. Use AddBlazorRegistrations() instead.")]
    [RequiresDynamicCode("Runtime type registration via reflection is not AOT-compatible. Use AddBlazorRegistrations() instead.")]
