...
namespace ISynergy.Framework.Mathematics.Integration
{
    ...
    ///             <item>
    ///                 <description>
    ///                     <a href="http://www.netlib.no/netlib/quadpack/qng.f">
        ...
        INumericalIntegration<NonAdaptiveGaussKronrodStatus>
    {
        ...
        public object Clone()
        {
            var clone = new NonAdaptiveGaussKronrod(
            ...
            out int neval, out int ier)
        {
            ...
            var epmach = Constants.DoubleEpsilon;
            var uflow = double.Epsilon;
            ...
            if (epsabs <= 0.0f && epsrel < Math.Max(5e-15, epmach * 50f)) goto L80;
            ...
            L25:
                ...
                for (k = 1; k <= 10; ++k) res43 += savfun[k - 1] * w43a[k - 1];
            ...
            L45:
                ...
                for (k = 1; k <= 21; ++k) res87 += savfun[k - 1] * w87a[k - 1];
                for (k = 1; k <= 22; ++k)
                {
                    absc = hlgth * x4[k - 1];
            ...
            L65:
                ...
                if (resabs > uflow / (epmach * 50.0f)) abserr = Math.Max(epmach * 50.0f * resabs, abserr);
