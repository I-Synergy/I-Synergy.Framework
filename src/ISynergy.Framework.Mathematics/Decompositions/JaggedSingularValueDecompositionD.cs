...
namespace ISynergy.Framework.Mathematics.Decompositions
{
    ...
    public sealed class JaggedSingularValueDecompositionD : ICloneable, ISolverArrayDecomposition<decimal>
    {
            ...
            bool computeLeftSingularVectors, bool computeRightSingularVectors, bool autoTranspose, bool inPlace)
        {
            ...
            LeftSingularVectors = new decimal[m][];
            for (var i = 0; i < LeftSingularVectors.Length; i++)
                LeftSingularVectors[i] = new decimal[nu];

            RightSingularVectors = new decimal[n][];
            for (var i = 0; i < RightSingularVectors.Length; i++)
                RightSingularVectors[i] = new decimal[n];
        ...
        public decimal[][] Inverse()
        {
            ...
            for (var i = 0; i < vrows; i++)
            {
                X[i] = new decimal[Diagonal.Length];
