...
namespace ISynergy.Framework.Mathematics.Decompositions
{
    ...
    ///     </para>
    /// </remarks>
    public sealed class JaggedQrDecompositionF : ICloneable, ISolverArrayDecomposition<float>
    {
        ...
        /// </param>
        public JaggedQrDecompositionF(float[][] value, bool transpose = false,
        ...
        public float[][] UpperTriangularFactor
        {
            get
            {
                ...
                var x = Jagged.Zeros<float>(rows, p);
        ...
        public float[][] OrthogonalFactor
        {
            get
            {
                ...
                var x = Jagged.Zeros<float>(n, cols);
        ...
        public float[][] Inverse()
        {
            ...
            return Solve(Jagged.Diagonal(n, n, (float)1));
        }
