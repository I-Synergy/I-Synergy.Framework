...
public interface IFileService<T>
{
    ...
    Task<List<T>> BrowseFileAsync(string filefilter, bool multiple = false, long maxFileSize = 1048576);
    ...
    Task<byte[]?> BrowseImageAsync(string[] filter, long maxFileSize = 1048576);
