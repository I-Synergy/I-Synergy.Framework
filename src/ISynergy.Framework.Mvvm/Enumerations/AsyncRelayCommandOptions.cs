...
namespace ISynergy.Framework.Mvvm.Enumerations
{
    ...
    public enum AsyncRelayCommandOptions
    {
        ...
        /// <list type="bullet">
        ///     <item>Concurrent execution is disallowed: a _command is disabled if there is a pending asynchronous execution running.</item>
        ///     <item>
        ///         <para>
        ...
        /// <summary>
        /// <para>Concurrent executions are allowed. This option makes it so that the same _command can be invoked concurrently multiple times.</para>
        /// <para>
