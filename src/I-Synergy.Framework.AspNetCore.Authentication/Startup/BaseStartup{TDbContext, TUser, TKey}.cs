...
namespace ISynergy.Framework.AspNetCore.Authentication
{
    ...
    /// <typeparam name="TKey">The type of the t user.</typeparam>
    /// <seealso cref="BaseStartup{TDbContext}" />
    /// <seealso cref="IAsyncInitialization" />
    public abstract class BaseStartup<TDbContext, TUser, TKey> : BaseStartup<TDbContext>, IAsyncInitialization
        where TDbContext : DbContext
        where TKey : IEquatable<TKey>
        where TUser : IdentityUser<TKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseStartup{TDbContext, TUser, TKey}"/> class.
        /// </summary>
